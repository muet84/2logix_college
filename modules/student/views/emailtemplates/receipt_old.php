...
<html lang="en">
  <head>
    ...
    <style>	html{font-family:sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%}
  ...
  <body>
	...
	<div class="container content">
		<div class="row">
			...
			<div class="col-xs-12 pad0">
				<div class="title"><h3><span>Other Student information</span></h3></div>
			</div>
			<div class="col-xs-12 pad0"><br/>
			...
			<div class="col-xs-12 pad0 form">
				...
				<div class="form-group col-md-12 col-xs-12 pad0">
					...
					<label class="col-md-1 col-xs-12 pad0">Other</label>
			...
			<div class="col-xs-12 pad0">
				<div class="title"><h3><span>Parent Information</span></h3></div>
			</div>
			<div class="col-md-12 col-xs-12 pad0 form">
			...
			<div class="col-md-12 col-xs-12 pad0 form">
				...
				<div class="form-group col-md-6 col-xs-12 padL0">
					<label class="col-md-2 col-xs-12 pad0">Contact #</label>
					<div class="col-md-10 col-xs-12 pad0">
						<input type="text" class="form-control"/>
					</div>
				</div>
				...
				<div class="col-xs-12 pad0">
					<p class="text-black inline">Have you ever been suspended, expelled or removed from any school?</p>&nbsp;&nbsp;
					<select class="w2"><option>Mother</option><option>Father</option></select>
				</div>
			</div>
			<div class="col-xs-12 pad0">
			...
			<div class="col-xs-12 pad0 table-responsive">
				<table class="table">
					...
					<tr class="bord">
						<td class="b noL"><input type="text" class="form-control"/></td>
						<td class="b"><select class="form-control"><option>Reception</option></select></td>
					</tr>
					<tr class="bord">
			...
			<div class="col-xs-12 pad0"><br/>
				<p class="text-black">Please tell us about any other siblings not at Bay View High or College</p>
			</div>
			<div class="col-xs-12 pad0 table-responsive">
				<table class="table">
					<tr class="bord">
			...
			<div class="col-xs-12 pad0 table-responsive">
				<table class="table noTdPadi">
					...
					<tr class="bord">
						<td class="b noL">
							<div class="checkbox">
								<input id="accounts" class="styled" type="checkbox">
								<label for="accounts">
						...
						<td class="b"><input type="text" class="form-control"/></td>
						<td class="b"><input type="text" class="form-control"/></td>
						<td class="b"><select class="form-control"><option>A*</option></select></td>
					</tr>
					<tr class="bord">
						<td class="b noL">
							<div class="checkbox">
			...
			<div class="col-xs-12 pad0"><br/>
				<p class="text-black">Please list all co-curricular activities that you have participated in since Class 9</p>
			</div>
			<div class="col-xs-12 pad0 table-responsive">
				<table class="table noTdPadi">
					<tr class="bord">
					...
					<tr class="bord">
						<td class="b noL"><input type="text" class="form-control"/></td>
						<td class="b"><select class="form-control"><option>Class 9</option></select></td>
						<td class="b"><input type="text" class="form-control"/></td>
						<td class="b"><input type="text" class="form-control"/></td>
						<td class="b"><input type="text" class="form-control"/></td>
					</tr>
			...
			<div class="col-xs-12 pad0 textarea"><br/>
				<p class="text-red"><strong>3. Do you wish to continue your involvement with co-curricular activities if you attend the college?</strong></p>
				<textarea class="form-control"><?= $model->sports_continue?></textarea><br/>
			</div>
			<div class="col-xs-12 pad0">
			...
			<div class="col-xs-12 pad0">
				...
				<p class="text-black">What Course of study do you wish to pursue after A Levels?</p>
			</div>
			<div class="col-xs-12 pad0 table-responsive">
				<table class="table noTdPadi2">
					<tr>
						<td class="bgRed">1</td>
						<td class="bgRed">2</td>
						<td class="bgRed">3</td>
			...
			<div class="col-xs-12 pad0">
				<div class="title"><h3><span>Personal Essay</span></h3></div>
			</div>
			<div class="col-xs-12 pad0"><br/>
			...
			<div class="col-xs-12 pad0"><br/>
				<p class="text-red"><strong>List documents to bring to the college</strong></p>
			</div>
			<div class="col-xs-12 pad0">
				<p>
					<ol class="text-black">
						<li>Report cards from Class 9 to 11</li>
						<li>CIE Certificates</li>
						...
						<li>Sealed Principals Report and Teachers Recommendation</li>
					</ol>
				</p>
			</div>
			<div class="col-xs-12 pad0"><br/>
				...
				<p class="text-black text-justify text-wrap">
                                    <strong>XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX<br/>
                                        XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX<br/>
                                        XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX</strong></p>
			</div>
